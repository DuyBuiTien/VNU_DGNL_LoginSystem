    ...
    <View style={{flex: 1, backgroundColor: '#FFF'}}>
      ...
      <View style={{margin: 10}}>
        ...
        <View
          ...
          <Text style={{color: '#FFF', fontWeight: 'bold', textAlign: 'center'}}>{data.TrangThaiMobile}</Text>
        </View>
      </View>
      <View style={{flex: 1}}>
        <ScrollableTabView
          ...
          <ScrollView
            ...
            <View style={{margin: 15, flexDirection: 'row'}}>
              ...
              <View style={{marginStart: 10, flex: 1}}>
                ...
                <Text style={{color: '#343F46', marginVertical: 10}}>{data.DonVi}</Text>
              </View>
            </View>
            ...
            <View style={{margin: 15, flexDirection: 'row'}}>
              ...
              <View style={{marginStart: 10, flex: 1}}>
                ...
                <Text style={{color: '#343F46', marginTop: 5}}>{data.NguoiNop}</Text>
                <Divider style={{backgroundColor: '#e8e8e8', marginTop: 10}} />

                <Text style={{color: '#343F46', fontSize: 16, marginTop: 10}}>CMND/CCCD</Text>
                <Text style={{color: '#343F46', marginTop: 5}}>{data.CMNDNguoiNop}</Text>
                <Divider style={{backgroundColor: '#e8e8e8', marginVertical: 10}} />

                <Text style={{color: '#343F46', fontSize: 16, marginTop: 10}}>Email</Text>
                <Text style={{color: '#343F46', marginTop: 5}}>{data.EmailNguoiNop}</Text>
                <Divider style={{backgroundColor: '#e8e8e8', marginVertical: 10}} />

                <Text style={{color: '#343F46', fontSize: 16, marginTop: 10}}>Địa chỉ</Text>
                <Text style={{color: '#343F46', marginTop: 5}}>{data.DiaChiNguoiNop}</Text>
                <Divider style={{backgroundColor: '#e8e8e8', marginVertical: 10}} />

                <Text style={{color: '#343F46', fontSize: 16, marginTop: 10}}>Số điện thoại</Text>
                <Text style={{color: '#343F46', marginTop: 5}}>{data.SoDienThoaiNguoiNop}</Text>
                <Divider style={{backgroundColor: '#e8e8e8', marginVertical: 10}} />
              </View>
            </View>
          </ScrollView>
