...
import {View, Text, Image, Modal, TouchableHighlight, Platform, Animated, Keyboard} from 'react-native';
    ...
    return (
      <TouchableComponent
        ...
        <View style={[Style.dateTouchBody, customStyles.dateTouchBody]}>
          ...
          (mode === 'datetime' && this.state.isPicker && this.state.newDate !== '') ? (
            <DateTimePicker mode="time" value={this.state.date} onChange={this.onTimePicked} display="clock" />
          ) : null}
