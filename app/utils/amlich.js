...
function getDayName(lunarDate) {
  ...
  var ngay = lunarDate.day;

  if (ngay < 11) {
    ngay = 'Mùng ' + ngay;
  }

  var thang = lunarDate.month;
  ...
  var s = `${ngay}, Tháng ${thang}, ${nam}`;

  if (lunarDate.day === 1 && lunarDate.month === 1) {
    s = `Tết Nguyên Đán, ${nam}`;
  } else if (lunarDate.day === 15 && lunarDate.month === 1) {
    s = `Tết Nguyên Tiêu, ${nam}`;
  } else if (lunarDate.day === 3 && lunarDate.month === 3) {
    s = `Tết Hàn Thực, ${nam}`;
  } else if (lunarDate.day === 10 && lunarDate.month === 3) {
    s = `Giỗ Tổ Hùng Vương, ${nam}`;
  } else if (lunarDate.day === 15 && lunarDate.month === 4) {
    s = `Lễ Phật Đản, ${nam}`;
  } else if (lunarDate.day === 5 && lunarDate.month === 5) {
    s = `Tết Đoan Ngọ, ${nam}`;
  } else if (lunarDate.day === 15 && lunarDate.month === 7) {
    s = `Lễ Vu Lan, ${nam}`;
  } else if (lunarDate.day === 15 && lunarDate.month === 8) {
    s = `Tết Trung Thu, ${nam}`;
  }
...
module.exports = {
  ...
  decodeLunarYear: decodeLunarYear,
  jdn2date: jdn2date,
  getCanChi: getCanChi,
  getDayName,
};
